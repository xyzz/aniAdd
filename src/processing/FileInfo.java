...
public class FileInfo {
	   public  FileInfo(File fileObj, int id){
           ...
           actionsDone = EnumSet.of(eAction.Process); actionsDone.remove(eAction.Process);
           actionsError = EnumSet.of(eAction.Process); actionsError.remove(eAction.Process);
