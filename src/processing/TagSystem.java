            ...
            while (doLoop) {
                ...
                if (doLoop) {
                    ...
                    switch (formatStr[line].charAt(pos)) {
                        case '"':
                            parseQuotes(node, pos, line);
                            break;
                        case '%':
                            parseVariables(node, pos, line);
                            break;
                        case '$':
                            parseFunction(node, pos, line);
                            break;
                        case '[':
                            parseChoose(node, pos, line);
                            break;
                        case '{':
                            parseCondition(node, pos, line);
                            break;
                        default:
                            throw new Exception();
                    }
