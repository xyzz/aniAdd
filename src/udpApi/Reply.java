...
public class Reply {
		...
		public Integer ReplyId() {return replyId;}
		public String ReplyMsg() {return replyMsg;}
		public ArrayList<String> DataField() {return dataField;}
		...
		public void ReplyId(Integer replyId) {this.replyId = replyId;}
		public void ReplyMsg(String reply) {this.replyMsg = reply;}
}
